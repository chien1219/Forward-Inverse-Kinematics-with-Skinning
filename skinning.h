...
public:
  ...
  void applySkinning(const RigidTransform4d * jointSkinTransforms, double * newMeshVertexPositions, FK * fk) const;
  void LinearBlendingSkinning(const RigidTransform4d * jointSkinTransforms, double * newMeshVertexPositions) const;
  void DualQuaternionsSkinning(const RigidTransform4d * jointSkinTransforms, double * newMeshVertexPositions, FK * fk) const;
